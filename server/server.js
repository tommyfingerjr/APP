...
app.post('/', async (req, res) => {
  try {
    ...
    const response = await openai.createCompletion({
      ...
      max_tokens: 4097, // The maximum number of tokens to generate in the completion. Most models have a context length of 2048 tokens (except for the newest models, which support 4096).
